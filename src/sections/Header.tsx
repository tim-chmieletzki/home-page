export default function Header() {
    return (
        <section className="top-6 z-10 sticky flex justify-between items-center bg-black/60 backdrop-blur-md mx-auto px-2 py-2 border border-[#2e2e2e] rounded-full max-w-xl text-sm">
